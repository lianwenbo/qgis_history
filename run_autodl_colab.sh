...
echo "📦 切分 patch 数据..."
python -c "
from unet_data_prep import split_into_patches
split_into_patches('map_line_dataset/raw_data', 'map_line_dataset/patch_data', patch_size=512, overlap=0.5)
"
echo ""
